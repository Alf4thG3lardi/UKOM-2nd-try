...
const Form = () => {
  return (
    <form id="kontak" className="container">
      <div className="text-center text-white mt-4 py-5">
        <h1 style={{ fontFamily:"Poppins"}}>Hubungi Kami</h1>
        <h5 className="text-white-50" style={{ fontFamily:"Roboto" }}>Hubungi Kami untuk Konsultasi dan Pembelian serta Seputar Informasi Menarik Lainnya.</h5>
      </div>
        ...
        <div className="row">
          <div className="col-4 ms-5">
            ...
            <div className="mb-4">
              ...
              <input type="text" className="form-control border-secondary border-3" id="inputEmail3" placeholder="Masukkan Email"></input>
            </div>
            <div className="mb-4">
              <label for="inputEmail3" className="col-3 form-label" style={{ fontFamily:"Roboto" }}>
                No.Telp :
              </label>
              <input type="text" className="form-control border-secondary border-3" id="inputEmail3" placeholder="Masukkan Nomor Telepon"></input>
            </div>
            <div className="mb-4">
              <label for="inputEmail3" className="col-3 form-label" style={{ fontFamily:"Roboto" }}>
                Perusahaan :
